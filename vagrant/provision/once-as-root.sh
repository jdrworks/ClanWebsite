...
mysql -uroot <<< "CREATE USER 'fknamazing'@'%' IDENTIFIED BY 'password'"
mysql -uroot <<< "GRANT ALL PRIVILEGES ON fknamazing.* TO 'fknamazing'@'%'"
mysql -uroot <<< "GRANT ALL PRIVILEGES ON fknamazing_test.* TO 'fknamazing'@'%'"
...
mysql -uroot <<< "CREATE DATABASE fknamazing"
mysql -uroot <<< "CREATE DATABASE fknamazing_test"
echo "Done!"
